  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--muted)] p-4">
      <motion.div
        ...
        className="w-full max-w-md glass p-8 rounded-2xl shadow-xl flex flex-col gap-8"
      >
        <div className="text-center">
          <h1 className="text-3xl font-bold tracking-tight text-[var(--foreground)] mb-2">AbleSpace</h1>
          <p className="text-sm text-[var(--muted-foreground)]">Login to manage your tasks</p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[var(--card)] px-2 text-[var(--muted-foreground)] rounded-full">
                Or
              </span>
            </div>
          </div>
